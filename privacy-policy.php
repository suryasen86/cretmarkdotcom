...
<body>
    <div class="main-content">
        <!-- <a  href="https://api.whatsapp.com/send?phone=+13653003154&text=hello">      <img style="width: 48px; height: 48px;" src="logo/whatsapp-2 1.svg"/></a> -->
        <!-- Start Header -->
                            ...
                            <div class="mainmenu-wrapepr justify-content-center">
                                ...
                                <nav class="mainmenu-nav d-none d-lg-block">
                                    <ul class="mainmenu">
                                        ...
                                        <li> <a href="https://api.whatsapp.com/send?phone=+13653003154&text=hello">      <img style="width: 48px; height: 48px;" src="logo/whatsapp-2 1.svg"/></a> </li>
